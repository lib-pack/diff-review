...
```shell
git clone https://github.com/<your-name-here>/diff-review
cd diff-review
pnpm install
```
...
Note that [console-fail-test](https://github.com/lib-pack/console-fail-test) is enabled for all test runs.
...
```shell
node ../diff-review/lib/hydrate/index.js -- description "Hooray, trying things out locally."
```
